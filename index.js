...
// the variable 'external' is globally scoped and available everywhere, while the variable 'internal' is function scoped and can be used anywhere inside 'myFunction', including within 'nestedFunction'
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(targetArray){
    const displayNames = []
  ...
  */
  ...
  function lowerCaseNames(targetArray){
    function animalLowerCase(item) {
      return item.animal_name.toLowerCase()
    }
    const lowerCaseArray = targetArray.map(animalLowerCase)
  ...
  */
  ...
  function lowPopulationAnimals(targetArray){
    function popCheck(item) {
      return item.population < 5
    }
    const lowPopArray = targetArray.filter(popCheck)
    return lowPopArray
  }
  ...
  */
  ...
  function USApop(targetArray){
    const totalPop = targetArray.reduce(function(total, currentElement) {
